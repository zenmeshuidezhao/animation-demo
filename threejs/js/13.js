...
const tick = () => {
    ...
    ghost2.position.x = Math.cos(-elapsedTime * 0.32) * 5;
    ghost2.position.z = Math.sin(-elapsedTime * 0.32) * 5;
    ghost2.position.y = Math.sin(-elapsedTime * 4) + Math.sin(-elapsedTime * 2.5)

    ghost3.position.x = Math.cos(-elapsedTime * 0.5) * 4;
    ghost3.position.z = Math.sin(-elapsedTime * 0.5) * 4;
